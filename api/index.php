        ...
        <div class="container hero-grid">
            ...
            <div class="hero-image-wrapper">
                <div class="hero-image-card">
                    <img src="/image/mariam-image-pro.png" alt="Mariam Tahayekt" onerror="this.src='https://via.placeholder.com/320x380?text=Mariam+Tahayekt'">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="projects" class="section">
        <div class="container">
            ...
            <div class="projects-grid">
                ...
                <!-- Projet 2 -->
                <div class="project-card">
                    <img src="/image/mariam-image-pro.png" alt="Portfolio Personnel" class="project-img" style="object-position: top;">
                    <div class="project-content">
